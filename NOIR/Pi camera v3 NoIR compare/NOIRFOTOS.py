...
def apply_color_map(ndvi_image):
    # Aplicar el mapa de colores JET
    colormap = cv2.applyColorMap(ndvi_image, cv2.COLORMAP_JET)
    return colormap


# Nombre del archivo de imagen en el mismo directorio que el script
...
ndvi_colormap = apply_color_map(ndvi)
display(ndvi_colormap, 'NDVI Color Map')
cv2.imwrite('ndvi_colormap.png', ndvi_colormap)
